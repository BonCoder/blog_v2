    ...
    <el-header class="header">
        <div class = lv-header>
            <el-row type="flex" justify="space-between">
                <h5 class="lv-logo" title="Bob的博客"><a id="index" href="/">{{configs.title}}</a></h5>
        ...
        <div class="lv-jside">
            <div :class="menu_bar_class" >
                ...
                <div class="logo" title="Bob的博客">
                    <a href="#"><img src="http://file.olo4.com/logo_2.png" alt="Bob`s Menu"/> </a>
                </div>
            </div>
                           ...
                           <div class="profile-pic">
                               <el-image v-if="user" :src="user.avatar" :alt="user.name">
                                    <div slot="placeholder" class="image-slot">
                                         <img class="art-banner" src="http://file.olo4.com/trans.ajax-spinner-preloader.svg">
                                    </div>
                               </el-image>
                               <el-image v-if="!user" src="http://file.olo4.com/Bob.png"></el-image>
                           </div>
                          </div>
